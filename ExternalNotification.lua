...
if Core:FindFirstChild("nNotifications") then Core:FindFirstChild("nNotifications"):Destroy() end
local UI = New("ScreenGui", {
	["IgnoreGuiInset"] = true; ["Name"] = "nNotifications"; ["ResetOnSpawn"] = false; ["ZIndexBehavior"] = "Global"
